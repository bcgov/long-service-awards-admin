...
export default function ContactData({ data }) {
  const { contact } = data || {};
  const { personal_phone, office_phone, office_address, personal_address } =
    contact || {};

  return (
    <Panel className={"mb-2 mt-2"} header={"Contact Details"} toggleable>
            ...
            >
              <div className={"container"}>
                <div className={"grid"}>
                  ...
                  <div className={"col-6"}>
                    <div>
                      {(personal_address && personal_address.street1) || "-"}
                    </div>
                    <div>
                      {(personal_address && personal_address.street2) || ""}
                    </div>
                  </div>
            ...
            <Panel header={"Office Address"} toggleable>
              <div className={"container"}>
                <div className={"grid"}>
                  ...
                  <div className={"col-6"}>
                    <div>
                      {(office_address && office_address.street1) || "-"}
                    </div>
                    <div>
                      {(office_address && office_address.street2) || ""}
                    </div>
                  </div>
                  <div className={"col-6"}>Community or City</div>
                  <div className={"col-6"}>
