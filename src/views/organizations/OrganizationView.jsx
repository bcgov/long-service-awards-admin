...
export default function OrganizationView({ data }) {
  const { name, abbreviation, previous_service_pins, active, bulk } =
    data || {};

  return (
    <Panel
      className={"mb-2 mt-2"}
      header={"Ministries/Organizations"}
      toggleable
    >
      <div className={"container"}>
        <div className={"grid"}>
          ...
          <div className={"col-6"}>Bulk</div>
          <div className={"col-6"}>{bulk ? "Yes" : "No"}</div>
