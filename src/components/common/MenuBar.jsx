...
function MenuBar() {
  ...
  const logo = (
    <img alt="logo" src={logoURL} height="60" className="mr-2"></img>
  );
  const profile = () => {
  ...
  if (isAdmin) {
    protectedItems.push.apply(protectedItems, [
      ...
      },
      {
        ...
        url: `${import.meta.env.LSA_APPS_ADMIN_URL}/attendees`,
      },
      {
        label: "Users",
        icon: "pi pi-fw pi-users",
  ...
  return (
    <>
      ...
      <Menubar model={items} start={logo} end={profile} />
    </>
  );
}
